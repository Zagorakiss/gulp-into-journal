...
<html lang="en" class="no-js">
	<head>
		...
		<title>Into Journal</title>
		<meta name="description" content="Into Journal" />
		...
		<div class="container container_header">
			<div class="clearfix">
					...
					<div class="ulinks">
						<ul class="ulinks__list ulinks__list_auth">
							<li class="ulinks__item">
								<a class="button button_green button_user" href="/login/">Войти</a>
							</li>
						</ul>
					</div>
				...
				<div class="header__rlink">
					<a href="https://intojob.ru/" class="rlink">Вернуться к работе</a>
				</div>
				<div class="header__menu">
					<div class="menu menu_header">
						<ul class="menu__list">
							<li class="menu__item">
								<a href="/" class="menu__link">Содержание</a>
							</li>
							<li class="menu__item">
								<a href="/read/" class="menu__link">Читать</a>
							</li>
							<li class="menu__item">
								<a href="/look/" class="menu__link">Смотреть</a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="bb-item">
						...
						<div class="bb-custom-side tatoos2">
							<div class="stake stake_third">
								...
								<div class="text">Изображение парусника на теле, еще один способ рассказать о достижениях моряка. Обладатель такой татуировки уже опытный мореплаватель,</div>
							</div>
							<div class="stake stake_third">
								...
								<div class="text">Эта тату еще старше якоря. Звезды всегда служили</div>
								<img class="img13" src="../img/journal/anchor.png" alt="">
							</div>
							<div class="stake stake_third">
								<div class="text">морякам ориентиром и путеводителем, а ветер помогал навигации. По этому изображение розы ветров на своем теле стало оберегом и гарантом благополучного пути.</div>
